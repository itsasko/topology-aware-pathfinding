...
path_klein_wa = run_ph_search(klein, G_klein, start, goal, method="weighted_astar", alpha=2.0, w=2.0)
path_klein_gbfs = run_ph_search(klein, G_klein, start, goal, method="greedy_bfs", alpha=2.0)

path_torus_astar = run_ph_search(torus, G_torus, start, goal, method="astar", alpha=2.0)
path_torus_wa = run_ph_search(torus, G_torus, start, goal, method="weighted_astar", alpha=2.0, w=2.0)
path_torus_gbfs = run_ph_search(torus, G_torus, start, goal, method="greedy_bfs", alpha=2.0)

path_crosscap_astar = run_ph_search(crosscap, G_crosscap, start, goal, method="astar", alpha=2.0)
path_crosscap_wa = run_ph_search(crosscap, G_crosscap, start, goal, method="weighted_astar", alpha=2.0, w=2.0)
path_crosscap_gbfs = run_ph_search(crosscap, G_crosscap, start, goal, method="greedy_bfs", alpha=2.0)
...
# Torus
compare_pairwise_paths(torus, G_torus, path_torus_a, path_torus_astar, "A*")
compare_pairwise_paths(torus, G_torus, path_torus_wa, path_torus_wa, "Weighted A*")
compare_pairwise_paths(torus, G_torus, path_torus_gbfs, path_torus_gbfs, "Greedy BFS")

# Crosscap
compare_pairwise_paths(crosscap, G_crosscap, path_crosscap_a, path_crosscap_astar, "A*")
compare_pairwise_paths(crosscap, G_crosscap, path_crosscap_wa, path_crosscap_wa, "Weighted A*")
compare_pairwise_paths(crosscap, G_crosscap, path_crosscap_gbfs, path_crosscap_gbfs, "Greedy BFS")
